...
from ..utility import NonnegativeInt, PositiveInt, Prob, concat_dict
...
class RNN(nn.Module):
    ...
    def forward(self, input_v: torch.Tensor, h_0: Optional[torch.Tensor]) -> Tuple[torch.Tensor, torch.Tensor]:
        """
